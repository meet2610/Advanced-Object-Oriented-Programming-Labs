...
public class TurtleCommandTurnLeft extends TurtleCommand {
	...
	/**
	 * Initialize this command so that this command is associated with the
	 * specified turtle executing a {@code turnLeft(delta)} command.
	 * 
	 * @param turtle
	...
	/**
	 * Runs the method {@code turnLeft(delta)} using the turtle associated with
	 * this command.
	 */
	@Override
	public void execute() {
